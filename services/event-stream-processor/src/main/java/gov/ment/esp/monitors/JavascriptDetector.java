...
public class JavascriptDetector extends EventMonitor {
  ...
  public JavascriptDetector(String monitorDef) throws ScriptException {
    ...
    if (evalresult == null) {
      ...
      throw new RuntimeException("unknown monitor of class "
              + evalresult.getClass().getCanonicalName() + " returned.");
    }
  }
  ...
  private Object unwrap(Object obj) {
    ...
    if (obj != null) {
      System.err.println("Cannot handle Javascript result of type "
