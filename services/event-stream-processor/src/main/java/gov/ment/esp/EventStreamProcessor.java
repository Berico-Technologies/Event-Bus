...
import gov.ment.esp.publish.PublishingService;
...
public class EventStreamProcessor {
  ...
  // TODO: consider making this a constructor parameter to allow for multiple
  // instances
  ...
  public void monitor(boolean isEPL, String pattern, EventMonitor monitor) {
    ...
    try {
      ...
      System.err
              .println("Error creating " + (isEPL ? "EPL" : "Pattern") + " statement: " + pattern);
      e.printStackTrace();
      throw e;
    }
    if (monitor != null) {
