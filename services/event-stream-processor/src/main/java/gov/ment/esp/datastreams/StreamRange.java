...
/**
 * A {@link StreamRange} is an entity on top of a full stream with START and END
 * markers to delimit the range of items of interest. Note that START and END
 * represent an exclusive interval, i.e. the START and END items are not part of
 * this sequence (allowing for an empty interval).
 * 
 * @author israel
 * 
 */
public class StreamRange {
  ...
  public void append(TimeEntry newEntry) {
    ...
    while (newEntry.getTimestamp() < last.getTimestamp()) {
      last = last.getPrev();
    }
