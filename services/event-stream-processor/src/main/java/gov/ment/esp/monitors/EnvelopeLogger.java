...
public class EnvelopeLogger extends EventMonitor {
  ...
  public void setlogdir(String logdir) {
    if (setupDir(logdir)) {
      ...
      System.err.println("Logging could not start into " + logdir + " at " + new Date() + "\n");
    }
  }
   ...
   * @param data
   *          The debug string to be written
   **/
  ...
  public InferredEvent receive(EventBean eventBean) {
    if (logdir != null) {
      ...
      if (env.getEventType().startsWith("dashboard.server.metric"))
        return null;
