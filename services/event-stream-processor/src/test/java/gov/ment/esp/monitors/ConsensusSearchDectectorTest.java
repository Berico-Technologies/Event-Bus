...
public class ConsensusSearchDectectorTest extends AbstractDetectorTest {
  ...
  public void testSearches() {
    ...
    Envelope reqJB1 =
            TestUtils.makeSearchRequest("James Bond", "Dr No personnel file and cam feed", "JB1");
    ...
    // TODO: check contents of the two CSEs (expecting 'sat' and 'imagery' with
    // freq 3 each)
    ...
    Envelope reqJB4 =
            TestUtils.makeSearchRequest("James Bond", "sat imagery for secret island", "JB4");
