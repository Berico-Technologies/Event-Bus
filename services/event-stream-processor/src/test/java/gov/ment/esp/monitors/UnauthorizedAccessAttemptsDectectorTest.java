...
public class UnauthorizedAccessAttemptsDectectorTest extends AbstractDetectorTest {
  ...
  public void testTwoUsersEachWithThreeUnauthorized() {
    ...
    Envelope reqSK3 =
            TestUtils.makeAuthRequest("Siegfried@Kaos.com", "cone-of-silence user manual", "SK3");
  ...
  public void testLimitFiveUnauthorized() {
    ...
    Envelope reqSK6 =
            TestUtils.makeAuthRequest("Siegfried@Kaos.com", "cone-of-silence user manual", "SK6");
