...
import gov.ment.esp.datastreams.Stream;
import gov.ment.esp.datastreams.TimeEntry;
    ...
    for (String range : expectedRanges) {
      for (String item : values) {
        ...
        System.out.println(String.format(
                "category = %s, item = %s, tot = %s, count = %s, trend = %s", range, item,
                ar.getTotal(), ar.getAdjustedSize(), ar.getTrend()));
        System.out.println();
      }
    }
  }
