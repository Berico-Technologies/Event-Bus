...
/**
 * Contains the Routing Information necessary to publish messages to or bind
 * queues onto an exchange.
 * 
...
public class RoutingInfo {
   ...
   *          The routing key (or binding expression)
   */
  public RoutingInfo(String exchangeName, ExchangeType exchangeType, boolean exchangeIsDurable,
          String routingKey) {
  ...
  public String toString() {
    return String.format("RoutingInfo [exchangeName=%s, routingKey=%s]", exchange.getName(),
            routingKey);
  }
  ...
  /**
   * More formally describes an Exchange, at least how the Event Bus API
   * utilizes them.
   * 
   * @author Ken Baltrinic (Berico Technologies)
   */
