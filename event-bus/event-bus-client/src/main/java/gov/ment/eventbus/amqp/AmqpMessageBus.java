...
/**
 * A source of indirection between a specific AMQP client (like RabbitMQ) and
 * the AmqpEventManager.
 * 
...
public interface AmqpMessageBus {
   ...
   * 
   * @param listener
   *          The listener to attach. If listener is already attached, the call
   *          is ignored.
   */
   ...
   * 
   * @param listener
   *          The listener to detach. If the listener is not attached, the call
   *          is ignored.
   */
  ...
  /**
   * Stops consuming messages that are being consumed as a result of a call to
   * beginConsumingMessages.
   * 
   * @param consumerTag
