...
public class TestSendEvent2 {

  private static final Logger LOG = LoggerFactory.getLogger(TestSendEvent2.class);
  ...
  public TestSendEvent2() {
  }

  public TestSendEvent2(String name, Date time, Integer count, String... excuses) {
    this.name = name;
    this.time = time;
    this.count = count;
  ...
  public void assertIsEquevalentTo(TestSendEvent2 event) {
