...
import gov.ment.eventbus.amqp.EventEnvelopeHandler;
...
public class EventEnvelopeHandler_HandleEnvelopeTest {
  ...
  @Mock
  private AmqpEventManager eventManager;
  @Mock
  ...
  @Test
  public void whenAnEventThatCannotBeDeserializedIsReceivedTheEnvelopeHandlerShouldReturnFailed()
          throws Exception {
  ...
  @Test
  public void whenTheEventHandlerThrowsAnExceptionTheEnvelopeHandlerShouldReturnFailed()
          throws Exception {
