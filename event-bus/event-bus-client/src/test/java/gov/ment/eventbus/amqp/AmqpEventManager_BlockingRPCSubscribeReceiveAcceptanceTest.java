...
public class AmqpEventManager_BlockingRPCSubscribeReceiveAcceptanceTest extends
  ...
  private void setupResponseMessage() {
    ...
    when(serializer.deserialize(bytesOfResponseMessage, TestResponseEvent.class)).thenReturn(
  ...
  @Test
  public void getResponseToShouldReturnTheDeserializedResponse() throws InterruptedException,
          TimeoutException {
