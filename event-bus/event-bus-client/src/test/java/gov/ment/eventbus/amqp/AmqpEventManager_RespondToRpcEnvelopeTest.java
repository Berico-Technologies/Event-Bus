...
public class AmqpEventManager_RespondToRpcEnvelopeTest extends
  ...
  public void beforeEachTest() {
    ...
    expectedRoute =
            new RoutingInfo(routingInfo.getExchange(), routingInfo.getRoutingKey()
                    + AmqpEventManager.AMQP_ROUTE_SEGMENT_DELIMITER + REPLY_TO_QUEUE);
  }
  ...
  public void theTopicOfThePublishedEnvelopeShouldBeTheRoutingKeyFromTheRoutingInfo() {
    assertEquals(expectedRoute.getRoutingKey(), publishedEnvelope.getTopic());
  }
