...
class EnvelopeHandlerBasedConsumer extends DefaultConsumer {
  ...
  @Override
  public void handleDelivery(String consumerTag, com.rabbitmq.client.Envelope amqpEnvelope,
    ...
    try {
      ...
      // TODO: what if handler incorrectly returns null? I think we should
      ...
      LOG.error("Envelope handler of type " + consumer.getClass().getCanonicalName() + " on queue "
              + queueName + " threw exception of type " + e.getClass().getCanonicalName()
