 ...
 * transform Objects into JSON Strings (and then to byte arrays) and JSON
 * Strings (originally as byte arrays) into Objects of supplied type (derived
 * from the EventHandler's "Class<? extends TEvent>[] getHandledEventTypes()"
 * method.
 * 
