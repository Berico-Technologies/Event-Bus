...
/**
 * Interface to be implemented by classes which provide handling of raw envelopes to be used in 
 * 		conjunction with the {@link Subscription} constructor(s) that accept envelope handlers
 * 		in lieu of event handlers.
 */
