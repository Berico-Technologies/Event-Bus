...
public interface EventManager {
     ...
     * @return a {@link SubscriptionToken} that uniquely identifies this subscription and can be used when invoking {@link EventHandler#unsubscribe(SubscriptionToken)}.
     */
     ...
     * @return an {@link SubscriptionToken} that should be passed to {@link EventHandler#unsubscribe(SubscriptionToken)} after all expected responses are received.
     */
