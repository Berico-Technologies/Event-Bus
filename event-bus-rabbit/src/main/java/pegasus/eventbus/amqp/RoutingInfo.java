...
/**
 * Contains the Routing Information necessary to publish messages to
 * or bind queues onto an exchange.
...
public class RoutingInfo{
	 ...
	 * @param exchangeIsDurable Is the Exchange Durable (persistent)?
	 * @param routingKey The routing key (or binding expression)
	 */
	...
	/**
	 * More formally describes an Exchange, at least how the
	 * Event Bus API utilizes them.
	 * @author Ken Baltrinic (Berico Technologies)
	 */
	public static class Exchange{
		 ...
		 * @param isDurable Is the Exchange durable?
		 */
