...
/**
 * Defines the requirements of a Serializer/Deserializer used
 * within the Event Bus client.
...
public interface Serializer {
	...
	/**
	 * Given a byte array and a class, return an instance of
	 * that class from the state of the byte array.
	 * @param bytes bytes to deserialize
	 * @param type desired type for deserialization
