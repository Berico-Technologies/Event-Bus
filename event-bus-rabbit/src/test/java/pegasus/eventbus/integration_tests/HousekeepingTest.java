...
public class HousekeepingTest extends IntegrationTestBase {
	...
	@Test @Ignore("This test has to be run manually.  Its purpose it to verify that publish and subscribe actions can recover from connection failures.  See comments.")
