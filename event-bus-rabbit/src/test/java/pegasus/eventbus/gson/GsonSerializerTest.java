...
//				{ "Simple string", "adjfoiaj95489" }, 
//				{ "Json string", "{key: \"value\"}"},
//				{ "TestType1", new TestType1()},
...
//		private String string ="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890-=+_)(*&^%$#@!`~{}|\\][:\"';/.,<>?";
...
//			result = prime * result
//					+ (int) (longInteger ^ (longInteger >>> 32));
//			result = prime * result + ((map == null) ? 0 : map.hashCode());
//			result = prime
//					* result
//					+ ((mapWithComplexKeys == null) ? 0 : mapWithComplexKeys
//							.hashCode());
//			result = prime * result
